...
ANCHOR = {  # 档: 单攻 全体 护盾 治疗 召数 召血 召攻 流血 护甲
    '白': (60, 30, 45, 35, 1, 48, 27, 10, 3),
    '绿': (88, 44, 66, 51, 1, 82, 40, 10, 4),
    '蓝': (129, 65, 97, 75, 1, 141, 58, 20, 5),
    '紫': (190, 95, 142, 111, 1, 241, 86, 20, 7),
    '金': (278, 139, 209, 162, 1, 413, 125, 40, 9),
    '橙': (409, 204, 307, 238, 1, 706, 184, 50, 11),
    '红': (600, 300, 450, 350, 1, 1210, 270, 60, 13),
}
...
C('冷','水','白','dual_h',['减速1'],'控制链·白(减速 1 回合)')
C('海','水','蓝','dual_h',['弹射3'],'2026-09-08 用户裁定:封禁→弹射,接手 溃 卸下的那条;单体形态(弹射只对 DamageSingle 生效)')
C('溃','水','蓝','dual_h',['终极技','群疗'],'涌泉梯队·低;群体形态见下方 §终极技的形态')
C('冻','水','绿','dual_h',['减速2'],'控制链·绿(减速 2 回合)')
C('澡','水','紫','dual_h',['封禁','弹射3'])
C('湮','水','紫','dual_h',['封禁','对控制'])
C('冰','水','金','dual_h',['冻结1','对控制'],'控制链·金(冻结 1 回合)')
C('沐','水','金','dual_h',['持续治疗','封禁','复活1'])
C('淼','水','橙','dual_h',['冻结2','对控制'],'控制梯队·高')
C('淋','水','橙','dual_h',['群疗','封禁2','减速2'])
C('㵘','水','红','dual_h',['终极技','群疗','冻结2','对控制'],'涌泉梯队·高')
...
C('壁','土','绿','dual_s',['反伤30'],'反伤链·绿(30%)')
C('堡','土','蓝','sum',['荆棘','嘲讽','入场护盾'],tank=100)
C('崩','土','蓝','dual_s',['终极技','群盾'],'厚积薄发·低')
C('碎','土','蓝','dual_s',['破甲'],'破甲链·蓝(削 20)')
C('塔','土','紫','sum',['荆棘','护甲(召)','入场护盾'],'反伤硬块;2026-09-08 用户换被动',tank=25)
C('圭','土','金','dual_s',['反伤50','对破甲'],'反伤链·金')
