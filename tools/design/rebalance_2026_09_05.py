...
# 不再是给我方挂 buff。两个字段随之 0 载体、进休眠(同 BurnNoDecay 那批处置)。
 ...
 '反伤50+镇压50':0.45,     # vs 反伤50 单独 0.35
...
C('澡','水','紫','dual_h',['封禁+解封','弹射3+治疗弹射3'])
...
C('塔','土','紫','dual_s',['反伤50+镇压50','护甲'],'2026-09-16 去召唤改双方向,不再是 sum;补护甲——「荆棘」是 SummonPassive.Thorns,\
召唤物专属被动,dual_s 没有载体,配上去会预算白扣、引擎零效果(2026-09-17 用户复核揪出的真 bug,已改)')
