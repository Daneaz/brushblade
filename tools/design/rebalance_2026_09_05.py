...
PRICE = {
 ...
 # 「主动机制哑火」扩到「主动 + 被动全禁」。比原沉默(0.35)更强,故 0.40 起步。
 '封禁':0.40,'封禁2':0.55,
...
C('鑫','金','橙','atk',['增攻50','战意+2'])
C('刲','金','橙','atk',['斩杀','偷袭','分2段'],'斩杀梯队·高')
C('䥱','金','红','atk',['破甲','战意+3','对破甲'],'破甲链·红(削 40)')
...
C('垚','土','橙','dual_s',['破甲','对破甲','护甲'],'破甲链·橙(削 35);护甲链·高')
