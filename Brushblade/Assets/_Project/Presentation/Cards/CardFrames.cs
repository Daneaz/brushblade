...
{
    /// <summary>字牌边框素材(《字牌形象关键词包》§2/§3):六档稀有度各一张框 + 蓝级以上一张光效层。
    /// 素材画布 192×240(0.8 竖版),牌面按同比例整体缩放,**不做 9-slice**。</summary>
    public static class CardFrames
    {
        ...
        private static readonly Dictionary<CardRarity, float> InsetPx = new()
        {
            ...
            { CardRarity.Orange, 19f },  // 最内细线 16
            { CardRarity.Red, 22f },     // 最内金线 19.2
        };
