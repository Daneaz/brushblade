...
namespace Brushblade.Core.Tests
{
    ...
    public class CampaignTests
    {
        ...
        /// 于是取一半。测试名与断言方向都反过来了,不是回归。
        ///
        /// ⚠ **2026-09-16:「为什么不是同速」那一半立论已随护甲百分比化作废**(原话是
        /// 「点数减法对小数值是开关不是削减,同速会让深层的低伤字全部归零」——
        /// 乘区模型下不存在这个开关效应,且 ApplyDefense 对正伤害有下限 1)。
        /// **半速这个数值本身未重新评估**,本条与 CampaignConfig.ScaledDefense 都原样保留;
        /// 详见 Core/Campaign.cs 上那条同款注记。</summary>
        [Test]
