...
namespace Brushblade.Core
{
    ...
    public static class MetaRules
    {
        ...
        public static readonly IReadOnlyList<string> StartingCollection = new[]
        {
            ...
            // 「白档召唤连发 2」改成了「蓝档单体攻击 + 破甲」——金系原来的白/绿/蓝三档
            // 全部错位,重新按当前字表挑齐(spec docs/superpowers/specs/2026-09-05-
            ...
            // 里才能被种子 1 的起手抽卡抽到,换成 锥 会让那条测试的前提失效。
            "利", "锋", "剿", // 金:白 增攻+30(2回合)+45 伤 / 绿 暴击+20%(3回合)+63 伤 / 蓝 112 伤+残血加伤(教程演示字)
            "枪", "藤", "箭", // 木:白 召唤·贯穿 / 绿 召唤·命中冻结 / 蓝 召唤·远程(补白档召唤三档空缺)
            "冷", "冻", "海", // 水:白 减速1+49伤(支援面回血 33)/ 绿 减速2+63伤(回血 42)/ 蓝 全体46伤+封禁(全体回血 32)
            "灭", "热", "爆", // 火:白 封禁+全体 19 伤 / 绿 90 伤+灼烧 1 / 蓝 全体 34 伤+全体灼烧 2
            "碉", "垒", "碎", // 土:白 召唤·反伤 50%/ 绿 盾 30+护甲 4+60 伤 / 蓝 盾 46+91 伤+破甲 20
        };
